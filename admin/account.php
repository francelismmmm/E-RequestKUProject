...
<html lang="en">
  ...
  <?php if($_GET["page"]=="all"){ echo "รายการบัญชีผู้ใช้ในระบบ";}
  if($_GET["page"]=="student_normal"){ echo "รายการบัญชีผู้ใช้ในระบบนิสิตภาคปกติ";}
  if($_GET["page"]=="studen_special"){ echo "รายการบัญชีผู้ใช้ในระบบนิสิตภาคพิเศษ";}
  if($_GET["page"]=="instructor"){ echo "รายการบัญชีผู้ใช้ในระบบอาจารย์ที่ปรึกษา";} 
  if($_GET["page"]=="officer"){ echo "รายการบัญชีผู้ใช้ในระบบเจ้าหน้าที่บริหารงานทั่วไป";}?></div></div>
  <div class="container"  >
  ...
  if(($q =='')){
    //query
 $query=mysqli_query($conn,"SELECT COUNT(id) FROM testdb");
 ...
 $nquery=mysqli_query($conn,"SELECT * from  testdb $limit");
...
$paginationCtrls .= ' &nbsp; &nbsp; <a href="'.$_SERVER['PHP_SELF'].'?pn='.$next.'" class="btn btn-info">Next</a> ';
  ...
  <?php 
            ...
            $query = "SELECT * FROM testdb WHERE role ='instructor' OR role = 'student' OR role = 'officer' ";
