...
<html lang="en">
  ...
  รายการบัญชีผู้ใช้ในระบบเจ้าหน้าที่บริหารงานทั่วไป </div></div>
  <div class="container"  >
  ...
  if(($q =='')){
    //query
 $query=mysqli_query($conn,"SELECT COUNT(id) FROM testdb WHERE role = 'officer' ");
 ...
 $nquery=mysqli_query($conn,"SELECT * from  testdb WHERE role = 'officer' $limit");
...
$paginationCtrls .= ' &nbsp; &nbsp; <a href="'.$_SERVER['PHP_SELF'].'?pn='.$next.'" class="btn btn-info">Next</a> ';
  ...
  <?php 
            ...
            $query = "SELECT * FROM testdb WHERE role = 'officer' ";
