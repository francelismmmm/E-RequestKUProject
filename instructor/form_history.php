...
<div class="container-md"   >
	<div class="row" style="position: absolute; top: -100px; display: flex;
		...
		<div class="col-md-12"  >
			...
			<form action="table_history.php" method="get" class="form-horizontal">
				<div class="form-group row">
					<div class="col-sm-5">
						<input type="text" name="q" class="form-control"  required placeholder="Search" style="width: 200px;" >
					</div>
					<div class="col-sm-2" style="position: absolute; right:25px;">
