  ...
  <?php 
           ...
           // echo '</font>';
            //echo '<br/>';  
                ...
                $query = "SELECT * FROM tb_pdf INNER JOIN testdb  ON tb_pdf.nisit_id = testdb.id_no WHERE tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode'AND tb_pdf.pdf_id LIKE '%$q%' 
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND tb_pdf.nisit_id LIKE '%$q%' 
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND tb_pdf.type_form LIKE '%$q%' AND tb_pdf.date_upload LIKE '%$date%' 
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND tb_pdf.date_upload LIKE '%$q%' 
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND testdb.name LIKE '%$q%'
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND testdb.lastname LIKE '%$q%'
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND testdb.title LIKE '%$q%'
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND CONCAT(testdb.name,' ',testdb.lastname) LIKE '%$q%'
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND CONCAT(testdb.title,testdb.name,' ',testdb.lastname) LIKE '%$q%'
                                                  OR tb_pdf.status_form  = 'In progress' AND tb_pdf.advisor_id ='$nisitcode' AND CONCAT(testdb.title,' ',testdb.name,' ',testdb.lastname) LIKE '%$q%'
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
       ...
       ?>
            ...
            <br>
            <a href="status_table.php"><button class='btn btn-outline-warning'>Reset</button></a>
          </div>
